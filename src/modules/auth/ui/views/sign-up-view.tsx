...
export const SignUpView = () => {
  ...
  const onSocialSignUp = (provider: "google" | "github") => {
    setError(null);
    setPending(true);
    ...
    <div className="flex flex-col gap-6">
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="bg-radial from-green-700 to bg-green-900 relative hidden md:flex flex-col items-center justify-center gap-y-4">
            <img src="/logo.svg" alt="logo" className="h-[92px] w-[92px]"></img>
            <p className="text-2xl font-semibold text-white">ConverseAI</p>
          </div>
        </CardContent>
      </Card>
